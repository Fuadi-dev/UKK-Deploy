        ...
        <header class="bg-white/80 backdrop-blur-lg shadow-sm border-b border-white/20 p-3 lg:p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="md:hidden flex items-center space-x-2">
                    <a href="{{ route('projects.show', $project->slug) }}" class="p-1 hover:bg-gray-100 rounded-lg transition-colors">
                        <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                        </svg>
                    </a>
                    <h2 class="text-lg font-bold text-gray-800 truncate">Edit Project</h2>
                </div>
        ...
        <main class="p-3 lg:p-6">
            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl shadow-2xl border border-white/20 p-4 lg:p-8">
                <div class="mb-6 lg:mb-8">
                    ...
                    <p class="text-gray-600 text-sm lg:text-base hidden md:block">Update project information and settings</p>
                </div>

                <form action="{{ route('projects.update', $project->slug) }}" method="POST" class="space-y-4 lg:space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <p class="text-xs lg:text-sm text-gray-500 mt-2 hidden md:block">Update the project status. You can also use quick actions from the project list page.</p>
                        @error('status')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
